# Naveena Mobile — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-naveena-mobile/
- **Repo:** `shreekantha3/sindagi-naveena-mobile` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-naveena-mobile/'` for GitHub Pages project-site hosting.
